...
voter inputs"]
    ...
    inputMaterialList ==> system
    inputEnergyList --> system
    inputInformationList -.-> system
...
indicators of how to use system features"]
    ...
    system==>outputMaterialList
    system-->outputEnergyList
    system-.->outputInformationList

    classDef outerBox stroke-width:0px,fill:none;
    class inputMaterial,inputEnergy,inputInformation,outputMaterial,outputEnergy,outputInformation outerBox;
